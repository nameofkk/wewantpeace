...
현재 기획부터 개발, 운영까지 1인으로 전담하고 있습니다. Freemium SaaS 모델로, 무료 플랜부터 Pro($3.90/월), Pro+($6.90/월)까지 제공합니다. 한국어·영어를 지원하고, PWA·Android 앱과 공개 API도 운영 중입니다.
