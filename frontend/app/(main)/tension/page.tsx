      ...
      <div className="sticky top-0 z-10 border-b border-border bg-background/95 backdrop-blur-sm px-4 pt-4 pb-0">
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", marginBottom: "12px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <h1 className="text-lg font-bold">{t(lang, "tension_title")}</h1>
            ...
            {crisisCount > 0 && (
              <span className="flex items-center gap-1 rounded-full bg-red-500/15 px-2 py-0.5 text-[10px] font-bold text-red-400">
                ...
                {t(lang, "tension_crisis")} {crisisCount}
              </span>
            )}
            {crisisCount === 0 && warningCount > 0 && (
              <span className="flex items-center gap-1 rounded-full bg-orange-500/15 px-2 py-0.5 text-[10px] font-bold text-orange-400">
                <AlertTriangle className="h-2.5 w-2.5" />
                {t(lang, "tension_warning")} {warningCount}
              </span>
            )}
          </div>
          {/* 중앙 — 로고 */}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "8px" }}>
            ...
            <span className="text-[10px] text-muted-foreground">
              {elapsed ? `${elapsed} ${t(lang, "tension_updated")}` : t(lang, "tension_refresh_interval")}
            </span>
          </div>
        </div>
