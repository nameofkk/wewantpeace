      ...
      <div className="sticky top-0 z-10 border-b border-border bg-background/95 backdrop-blur-sm px-4 pt-4 pb-0">
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <div className="flex items-center gap-1.5 min-w-0 overflow-hidden">
            <h1 className="text-base font-bold shrink-0">{t(lang, "tension_title")}</h1>
            ...
            {crisisCount === 0 && warningCount > 0 && (
              <span className="shrink-0 flex items-center gap-1 rounded-full bg-orange-500/15 px-1.5 py-0.5 text-[10px] font-bold text-orange-400">
                <AlertTriangle className="h-2.5 w-2.5" />
                {warningCount}
              </span>
            )}
