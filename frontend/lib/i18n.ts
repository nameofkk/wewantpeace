...
export const translations = {
  ko: {
    ...
    dash_report_title: "{name}님의 실시간 영향 리포트",
    dash_report_subtitle: "전 세계 197개국 분쟁 모니터링 기반 맞춤 분석",
    dash_report_generated: "마지막 분석: {time}",
    dash_your_impact: "{name}님의 종합 영향도",
    dash_impact_level_high: "높음",
    dash_impact_level_elevated: "경계",
    dash_impact_level_guarded: "주의",
    dash_impact_level_low: "안정",
    dash_impact_summary_label: "분석 요약",
    dash_active_issues: "활성 이슈",
    dash_high_impact: "고영향",
    dash_affected_sectors: "영향 산업",
    dash_home_tension: "기준 국가 긴장도",
    dash_global_overview: "글로벌 현황",
    dash_extreme_count: "극심 {n}개국",
    dash_severe_count: "심각 {n}개국",
    dash_alert_count: "경계 {n}개국",
    dash_global_stable: "글로벌 안정",
    dash_watchlist: "관심 국가",
    dash_watchlist_empty: "관심 국가를 추가하세요",
    dash_watchlist_add: "국가 추가",
    dash_top_issues: "{name}님에게 영향이 큰 이슈",
    dash_top_issues_sub: "기준 국가 기준 영향도 상위 5건",
    ...
    dash_ai_estimate: "공개 데이터 기반 추정치 · 의사결정 전 전문가 상담을 권장합니다",
    dash_impact_score: "영향도",
    dash_risk_desc: "설정한 홈 국가의 분쟁 긴장도를 0~100 점수로 표시합니다. 공개 뉴스 데이터를 기반으로 15분마다 갱신됩니다.",
    dash_watchlist_desc: "관심 국가의 긴장도를 한눈에 확인하세요. 터치하면 상세 추이를 볼 수 있습니다.",
    dash_top_issues_desc: "전 세계 197개국 분쟁 이슈 중 {name}님의 홈 국가에 영향이 큰 순으로 정렬됩니다.",
    dash_impact_brief_desc: "경제·무역·여행 영향도 분석. 공개 데이터 기반 추정치입니다.",
    dash_sector_desc: "산업 섹터별 교역 의존도와 분쟁 리스크를 분석합니다.",
    dash_trade_flow: "교역 흐름",
    dash_trade_flow_desc: "분쟁 관련 국가 간 교역 흐름을 시각화합니다.",
    trade_collapse: "접기",
    trade_expand: "교역 흐름 시각화 보기",
    trade_pro_only: "교역 흐름 시각화는 Pro+ 전용입니다",
    trade_load_error: "데이터를 불러올 수 없습니다",
    trade_no_data: "교역 데이터가 아직 없습니다",
    trade_data_source: "데이터: UN Comtrade / World Bank. 실제 교역 데이터 기반이며 투자 자문이 아닙니다.",
    ...
    dash_notice_ticker: "공지",
    dash_section_info: "이 섹션은 무엇인가요?",
    dash_pro_detail: "{name}님을 위한 상세 분석",
    dash_pro_economy: "경제",
    dash_pro_trade: "무역",
    dash_pro_travel: "여행",
    dash_pro_locked: "Pro 플랜에서 경제·무역·여행 맞춤 분석을 확인하세요",
    dash_personalized_for: "{name}님 맞춤",
    dash_monitoring_worldwide: "전 세계 197개국 실시간 모니터링",
    // Phase 2: 시장 동향 + 교역 노출도 + 여행 경보
    dash_market_trend: "분쟁 영향 시장 동향",
    dash_market_subtitle: "주요 원자재·환율·지수 변동",
    dash_market_oil: "원유",
    dash_market_gold: "금",
    dash_market_forex: "환율",
    dash_market_index: "주가지수",
    dash_market_disclaimer: "시장 정보이며 투자 조언이 아닙니다 · 출처: Yahoo Finance (지연 데이터)",
    dash_market_conflict_label: "분쟁 경제 지표",
    dash_trade_exposure: "교역 노출도",
    dash_trade_dependency: "의존도",
    dash_trade_volume: "교역액",
    dash_trade_unit: "백만 달러",
    dash_travel_alert: "여행 경보",
    dash_travel_level_1: "여행유의",
    dash_travel_level_2: "여행자제",
    dash_travel_level_3: "출국권고",
    dash_travel_level_4: "여행금지",
    dash_travel_source: "출처: US State Dept",
    dash_issue_reason: "영향 이유",
    dash_kscore_change: "24h 변화",
    dash_tab_market: "시장 동향",
    dash_tab_trade: "교역 노출",
    dash_tab_travel: "여행 경보",
    dash_chain_conflict: "분쟁",
    dash_chain_indicator: "지표 영향",
    dash_chain_your_impact: "나의 영향",
    dash_chain_detail: "상세 보기",
    dash_top_issue_label: "가장 영향이 큰 이슈",
    dash_compact_tension: "긴장도",
    dash_impact_score_desc: "나에게 미치는 영향",
    dash_tension_desc: "분쟁 강도",
    dash_global_tension: "글로벌 긴장도",
    dash_global_tension_desc: "전 세계 평균",
    dash_global_impact_desc: "전 세계 기준 영향도",
    dash_market_free_comment: "현재 분쟁 상황이 에너지 가격과 금융 시장에 영향을 미치고 있습니다",
    dash_trade_pro_comment: "교역 의존도가 높은 국가에서 분쟁이 발생하면 공급망 리스크가 증가합니다",
    dash_travel_comment: "{n}개국에 여행 경보가 발령 중입니다",
    dash_travel_comment_severe: "가장 심각: {country} (Lv.{level})",
    settings_community: "커뮤니티",
    settings_community_desc: "다른 사용자들과 분쟁 이슈에 대해 토론하세요",
    ...
    community_bookmark: "북마크",
    community_bookmarked: "북마크됨",
    community_bookmarks_title: "저장한 글",
    community_bookmarks_empty: "저장한 글이 없습니다",
    ...
    paywall_pro_feature_kscore: "위험지수 3.0~ · 30일 히스토리",
    paywall_pro_feature_quiet: "방해금지 시간 설정",
    paywall_pro_feature_sector: "산업별 리스크 개요",
    ...
    settings_plan_pro_desc: "관심 국가 5개 · 일일 20건 · 신뢰 알림 · 토픽 필터 · 위험지수 3.0~ · Intel 레이어 · 교역 흐름 분석 · AI 영향 분석 · 산업별 리스크 개요",
    settings_plan_free_desc: "관심 국가 {n}개 · 일일 5건 · 위험지수 4.0 고정",
    ...
    glossary_trending_desc: "홈 화면에 표시되는 실시간 주요 이슈 목록. 위험지수 순으로 정렬되며 15분마다 갱신됩니다.",
    ...
    glossary_kscore: "위험지수 (Risk Level)",
    ...
    glossary_kscore_alert: "위험지수 알림",
    glossary_kscore_alert_desc: "위험지수가 사용자의 임계값을 넘는 이슈가 발생하면 푸시 알림. 기준 국가 관점 위험지수로 계산됩니다.",
    glossary_home_country: "기준 국가",
    glossary_home_country_desc: "위험지수 계산의 기준이 되는 국가. 이 국가 관점에서 글로벌 이슈의 영향도를 계산합니다.\nFree=글로벌, Pro 이상 개인화 가능.",
    glossary_watched_country: "관심 국가",
    glossary_watched_country_desc: "알림을 받을 국가. 이 국가에서 발생한 이슈가 위험지수 임계값을 넘으면 알림이 발송됩니다.\nFree 2개, Pro 5개, Pro+ 무제한.",
    glossary_fast_alert: "속보 알림 (Fast Alert)",
    glossary_fast_alert_desc: "위험지수가 임계값을 넘으면 즉시 발송되는 알림. 공식 확인 전이라 오탐 가능성이 있습니다.\n모든 플랜에서 사용 가능.",
    ...
    issue_kscore_history_expand: "위험지수 추이 보기",
    issue_kscore_history_collapse: "위험지수 추이 접기",
    issue_kscore_history_section: "위험지수 추이",
    ...
    country_issue_kscore_alert: "위험지수 알림",
    ...
    map_kscore_legend: "위험지수: 극심 8↑ / 심각 6~8 / 경계 4~6 / 주의 2~4 / 안정 2↓",
    map_popup_kscore_alert: "위험지수 알림",
    map_popup_verified: "✓ 검증",
    map_popup_grouped: "총 {n}개 이슈",
    map_popup_rep_note: "위험지수가 가장 높은 이슈가 대표로 표시됩니다",
    ...
    onboarding_notify_desc: "위험지수 기반 알림으로 중요한 이슈를 즉시 알려드립니다. 알림은 설정에서 언제든 변경 가능합니다.",
    ...
    settings_home_country_desc: "위험지수가 기준 국가 관점에서 계산됩니다",
    settings_home_country_pro_hint: "다른 국가로 변경하려면 Pro 플랜이 필요합니다",
    home_country_basic_label: "글로벌 (전체)",
    ...
    settings_fast_info: "위험지수 기반으로 빠르게 알려드려요. 공식 확인 전이라 오탐이 있을 수 있어요.",
    ...
    settings_plan_feature_kscore_range: "위험지수 범위",
    ...
    settings_plan_proplus_desc: "무제한 국가 · 일일 100건 · 위험지수 1.5~ · 이슈별 산업 리스크 · 주간 리포트 · 90일 히스토리",
    ...
    admin_pricing_label: "요금 설정 (USD 센트)",
    ...
    web_payment_provider: "DodoPayments를 통해 안전하게 결제됩니다",
    ...
    // 통합 페이지
    admin_issues: "이슈 관리",
    admin_issues_tab_clusters: "클러스터",
    admin_issues_tab_events: "이벤트",
    admin_monitoring: "모니터링",
    admin_monitoring_tab_kscore: "KScore 트렌딩",
    admin_monitoring_tab_tension: "긴장도 인덱스",
    admin_avg_severity: "평균 심각도",
    admin_unclassified_rate: "미분류율",
    // 주간 리포트
    admin_wr_tab_preview: "미리보기",
    admin_wr_tab_edit: "편집",
    admin_wr_tab_history: "발송 기록",
    admin_wr_editor_note: "에디터 노트",
    admin_wr_editor_note_ko: "에디터 노트 (한국어)",
    admin_wr_editor_note_en: "에디터 노트 (English)",
    admin_wr_editor_note_placeholder: "이번 주 특이사항이나 코멘트를 작성하세요...",
    admin_wr_save_draft: "초안 저장",
    admin_wr_draft_saved: "초안이 저장되었습니다",
    admin_wr_send_test: "테스트 발송",
    admin_wr_send_all: "전체 발송",
    admin_wr_send_confirm: "정말 전체 발송하시겠습니까?",
    admin_wr_send_target: "발송 대상",
    admin_wr_send_target_count: "{count}명",
    admin_wr_last_sent: "마지막 발송",
    admin_wr_send_success: "발송 완료",
    admin_wr_send_fail: "발송 실패",
    admin_wr_history_date: "발송일",
    admin_wr_history_sent: "발송수",
    admin_wr_history_failed: "실패수",
    admin_wr_history_status: "상태",
    admin_wr_no_history: "발송 기록이 없습니다",
    admin_wr_email_preview: "이메일 미리보기",
    admin_wr_drag_reorder: "드래그하여 순서 변경",
    admin_wr_exclude: "제외",
    admin_wr_restore: "복원",
    ...
    ob_hero_monitoring: "현재 230+개국 모니터링 중",
    ob_hero_impact: "글로벌 분쟁이 나에게 미치는 영향 분석",
    ob_hero_cta: "시작하기",
    ...
    weekly_report_tension: "관심 국가 긴장도 추이",
    weekly_report_upgrade_cta: "Pro로 업그레이드하면 관심 국가 추이를 확인할 수 있어요",
    ...
    weekly_report_cta: "앱에서 관심 국가 추이 확인",
    ...
    // Welcome Modal
    welcome_title: "분쟁이 내 지갑에 미치는 영향",
    welcome_subtitle: "매일 30초, 분쟁 날씨를 확인하세요",
    welcome_feat_1: "분쟁이 주유비·식료품·항공료에 미치는 영향을 알려드려요",
    welcome_feat_2: "13개 기관 실시간 데이터 + 위성 교차검증",
    welcome_feat_3: "내 생활에 영향이 올 때 즉시 알림을 보내드려요",
    welcome_trust_1: "다국적 뉴스 + 위성·센서 데이터 수집",
    welcome_trust_2: "예측이 아닌 사실 기반 분석",
    welcome_trust_3: "무료 이용 가능",
    welcome_cta: "오늘의 분쟁 날씨 보기",
    ...
    tour_home_country_picker: "기준 국가를 바꾸면 위험지수 순위가 해당 국가 관점으로 재정렬됩니다.",
    tour_home_rising: "최근 6시간 내 새로 등장하여 빠르게 확산 중인 이슈입니다.",
    tour_home_kscore_history: "카드 하단의 '위험지수 추이 보기'를 눌러 시간별 변화를 추적할 수 있습니다.",
    ...
    tour_dash_top_issues: "나에게 영향이 가장 큰 이슈 TOP 5입니다. 위험지수 기반으로 개인화됩니다.",
    ...
    // 가이드 투어 — Settings
    tour_settings_page_role: "알림, 기준 국가, 관심 국가 등 개인 설정을 관리하는 페이지입니다.",
    tour_settings_home_country: "기준 국가: 위험지수가 이 국가 관점에서 계산됩니다. 알림도 이 위험지수 기준으로 발송됩니다. Pro 이상에서 변경 가능.",
    tour_settings_watched: "관심 국가: 이 국가에서 발생한 이슈를 우선 모니터링합니다. 속보/신뢰 알림을 개별 설정할 수 있습니다.",
    tour_settings_notifications: "위험지수 임계값을 조절하여 알림 민감도를 설정합니다. 값이 낮을수록 더 많은 알림을 받습니다.",
    tour_settings_kscore_slider: "위험지수 슬라이더: 기준 국가 관점의 위험지수가 이 값을 넘으면 알림이 발송됩니다. 플랜에 따라 조절 범위가 다릅니다.",
    ...
    dash_section_hero_title: "영향도",
    dash_section_hero_desc: "나에게 미치는 영향",
    dash_section_hero_tooltip: "분쟁이 내 국가 경제·생활에 미치는 종합 영향도 (0-100). 5축 레이더로 군사·에너지·무역·식량·금융 분야별 리스크를 분해합니다.",
    dash_section_radar_tooltip: "5개 분야별 이번 주(빨강) vs 지난주(회색 점선) 리스크 비교. 영역이 넓을수록 해당 분야 리스크가 높습니다.",
    dash_section_flow_tooltip: "분쟁(왼쪽) → 산업/원자재(가운데) → 내 생활비(오른쪽)로 이어지는 영향 경로. 흐름이 두꺼울수록 영향이 큽니다.",
    dash_section_stories_title: "주요 이슈",
    dash_section_stories_desc: "나와 가장 관련 높은 분쟁 이슈",
    dash_section_stories_tooltip: "종합 영향도가 높을수록 내 국가·경제에 직접 관련된 이슈입니다. 무슨 일(사건) → 나에게(영향) → 언제(시점) 3줄로 핵심을 요약합니다.",
    dash_section_dashboard_title: "데이터",
    dash_section_dashboard_desc: "시장·교역·여행·분석 상세",
    dash_tab_market_desc: "분쟁 영향을 받는 원자재·지수·환율",
    dash_tab_trade_desc: "내 국가와 분쟁국 간 교역 의존도",
    dash_tab_travel_desc: "분쟁국 여행 경보 단계",
    dash_tab_detail_desc: "AI 종합 분석 코멘트",
    ...
    // UCDP 분쟁 기록 (국가 페이지)
    ucdp_section_title: "분쟁 기록",
    ucdp_period: "{start}~{end}: {count}건의 기록된 분쟁",
    ucdp_actors: "주요 행위자: {actors}",
    ucdp_fatalities: "누적 사망자: 약 {low}~{high}명",
    ucdp_source: "UCDP GED · CC-BY 4.0",
    ...
    // 뉴스레터 마케팅 꼬드기
    marketing_newsletter_benefit: "📬 환율·유가 흔드는 분쟁 뉴스, 매주 월요일 3분 정리",
    marketing_newsletter_detail: "한 주간의 글로벌 리스크를 한눈에 · 무료 · 언제든 해지",
    ...
    // 뉴스레터 CTA
    newsletter_title: "월요일 아침 3분 브리핑",
    newsletter_desc: "분쟁이 환율·유가·공급망에 미치는 영향, 매주 월요일 정리",
    newsletter_toggle_label: "이메일로 받기",
    newsletter_toggle_sub: "뉴스레터·마케팅",
    newsletter_preview: "미리보기",
    newsletter_subscribers: "{n}명이 읽는 중 · 무료 · 3분 분량",
    newsletter_login_subscribe: "무료로 받아보기",
    newsletter_login_sub: "로그인 후 무료 구독",
    newsletter_subscribed: "구독 중",
    newsletter_next_send: "구독 중 · 다음 발송 월요일",
    newsletter_archive_title: "뉴스레터 아카이브",
    newsletter_archive_desc: "지난 뉴스레터를 확인해보세요",
  ...
  en: {
    ...
    dash_your_impact: "{name}'s Overall Impact",
    dash_impact_level_high: "High",
    dash_impact_level_elevated: "Elevated",
    dash_impact_level_guarded: "Guarded",
    dash_impact_level_low: "Stable",
    dash_impact_summary_label: "Summary",
    dash_active_issues: "Active",
    dash_high_impact: "High Impact",
    dash_affected_sectors: "Sectors",
    dash_home_tension: "Base Country Tension",
    dash_global_overview: "Global Overview",
    dash_extreme_count: "Extreme {n}",
    dash_severe_count: "Severe {n}",
    dash_alert_count: "Alert {n}",
    dash_global_stable: "Global Stable",
    dash_watchlist: "Watchlist",
    dash_watchlist_empty: "Add countries to your watchlist",
    dash_watchlist_add: "Add Countries",
    dash_top_issues: "Issues Affecting {name}",
    dash_top_issues_sub: "Top 5 by impact on your base country",
    ...
    dash_ai_estimate: "Data-driven estimate · Consult experts before making decisions",
    dash_impact_score: "Impact",
    dash_risk_desc: "Shows your base country's conflict tension on a 0–100 scale. Updated every 15 minutes based on open news data.",
    dash_watchlist_desc: "Monitor tension levels of your watchlist countries at a glance. Tap for detailed trends.",
    dash_top_issues_desc: "Global conflict issues across 197 countries ranked by impact on {name}.",
    dash_impact_brief_desc: "Economic, trade, and travel impact analysis. Estimates based on public data.",
    dash_sector_desc: "Analyzes trade dependency and conflict risk by industry sector.",
    dash_trade_flow: "Trade Flow",
    dash_trade_flow_desc: "Visualizes trade flows between conflict-affected countries.",
    trade_collapse: "Collapse",
    trade_expand: "View trade flow visualization",
    trade_pro_only: "Trade flow visualization is Pro+ only",
    trade_load_error: "Failed to load data",
    trade_no_data: "No trade data available yet",
    trade_data_source: "Data: UN Comtrade / World Bank. Based on actual trade data, not investment advice.",
    ...
    dash_notice_ticker: "Notice",
    dash_section_info: "What is this section?",
    dash_pro_detail: "Detailed Analysis for {name}",
    dash_pro_economy: "Economy",
    dash_pro_trade: "Trade",
    dash_pro_travel: "Travel",
    dash_pro_locked: "Unlock economy, trade & travel analysis with Pro",
    dash_personalized_for: "For {name}",
    dash_monitoring_worldwide: "Monitoring 197 countries in real time",
    // Phase 2: Market Trends + Trade Exposure + Travel Advisory
    dash_market_trend: "Conflict Impact on Markets",
    dash_market_subtitle: "Key commodities, forex & indices",
    dash_market_oil: "Oil",
    dash_market_gold: "Gold",
    dash_market_forex: "Forex",
    dash_market_index: "Indices",
    dash_market_disclaimer: "Market data for informational purposes only, not investment advice · Source: Yahoo Finance (delayed)",
    dash_market_conflict_label: "Conflict Economic Indicators",
    dash_trade_exposure: "Trade Exposure",
    dash_trade_dependency: "Dependency",
    dash_trade_volume: "Volume",
    dash_trade_unit: "M USD",
    dash_travel_alert: "Travel Advisory",
    dash_travel_level_1: "Normal Precautions",
    dash_travel_level_2: "Increased Caution",
    dash_travel_level_3: "Reconsider Travel",
    dash_travel_level_4: "Do Not Travel",
    dash_travel_source: "Source: US State Dept",
    dash_issue_reason: "Impact Reason",
    dash_kscore_change: "24h Change",
    dash_tab_market: "Market",
    dash_tab_trade: "Trade Exposure",
    dash_tab_travel: "Travel Advisory",
    dash_chain_conflict: "Conflict",
    dash_chain_indicator: "Indicator Impact",
    dash_chain_your_impact: "Your Impact",
    dash_chain_detail: "View Details",
    dash_top_issue_label: "Highest Impact Issue",
    dash_compact_tension: "Tension",
    dash_impact_score_desc: "Impact on you",
    dash_tension_desc: "Conflict intensity",
    dash_global_tension: "Global Tension",
    dash_global_tension_desc: "Worldwide average",
    dash_global_impact_desc: "Worldwide impact",
    dash_market_free_comment: "Current conflicts are impacting energy prices and financial markets",
    dash_trade_pro_comment: "Conflicts in high trade-dependency countries increase supply chain risk",
    dash_travel_comment: "Travel advisories active in {n} countries",
    dash_travel_comment_severe: "Most severe: {country} (Lv.{level})",
    settings_community: "Community",
    settings_community_desc: "Discuss conflict issues with other users",
    ...
    community_bookmarks_title: "Saved Posts",
    community_bookmarks_empty: "No saved posts yet",
    ...
    paywall_pro_feature_kscore: "Risk level 3.0+ · 30-day history",
    paywall_pro_feature_quiet: "Quiet hours setting",
    paywall_pro_feature_sector: "Sector risk overview",
    ...
    settings_plan_pro_desc: "5 countries · 20/day · Verified alerts · Topic filter · Risk level 3.0+ · Intel layers · Trade flow analysis · AI impact analysis · Sector risk overview",
    settings_plan_free_desc: "{n} countries · 5/day · Risk level 4.0 fixed",
    ...
    glossary_trending_desc: "The real-time list of major issues displayed on the home screen, ranked by risk level and updated every 15 minutes.",
    ...
    glossary_kscore: "Risk Level",
    glossary_kscore_desc: "A 0-10 score of how an issue impacts your base country.\nTrending score × country impact factor (geo, security, economic).",
    ...
    glossary_kscore_alert: "Risk Level Alert",
    glossary_kscore_alert_desc: "Push alerts triggered when an issue's risk level exceeds your threshold. Calculated from your base country's perspective.",
    glossary_home_country: "Base Country",
    glossary_home_country_desc: "The country used as the basis for risk level calculation. Global issues are scored based on their impact on this country.\nFree=Global, Pro and above can customize.",
    glossary_watched_country: "Watched Country",
    glossary_watched_country_desc: "Countries you want alerts for. When an issue in these countries exceeds your risk level threshold, you'll be notified.\nFree: 2, Pro: 5, Pro+: Unlimited.",
    glossary_fast_alert: "Fast Alert",
    glossary_fast_alert_desc: "Sent immediately when risk level exceeds your threshold. May include unverified reports.\nAvailable on all plans.",
    ...
    issue_kscore_history_expand: "View Risk Trend",
    issue_kscore_history_collapse: "Collapse Risk Trend",
    issue_kscore_history_section: "Risk Trend",
    ...
    country_issue_kscore_alert: "Risk Alert",
    ...
    map_kscore_legend: "Risk Level: Extreme 8+ / Severe 6–8 / Alert 4–6 / Caution 2–4 / Stable <2",
    map_popup_kscore_alert: "Risk Alert",
    ...
    map_popup_kscore_tooltip: "Key Impact Score (0–10). Real-time issue impact from your base country's perspective.",
    ...
    onboarding_notify_desc: "Get risk-level-based alerts for important issues instantly. You can change this anytime in Settings.",
    ...
    notif_saving: "Saving...",
    notif_saved: "Saved",
    notif_kscore_title: "Min. risk level",
    notif_kscore_desc: "Only receive alerts at or above this risk level (lower = more alerts)",
    ...
    settings_home_country: "Base Country",
    settings_home_country_desc: "Risk level is calculated from your base country's perspective",
    settings_home_country_pro_hint: "Pro plan required to change to other countries",
    home_country_basic_label: "Global (All)",
    ...
    settings_fast_info: "Risk-level-based quick alerts. May include unconfirmed reports.",
    ...
    settings_plan_feature_kscore_range: "Risk level range",
    ...
    settings_plan_proplus_desc: "Unlimited countries · 100/day · Risk level 1.5+ · Per-issue sector risk · Weekly report · 90-day history",
    ...
    admin_pricing_label: "Pricing (USD cents)",
    ...
    // DodoPayments web payment
    web_subscribe_button: "Subscribe",
    web_subscribe_loading: "Preparing checkout...",
    web_payment_provider: "Secure payment via DodoPayments",
    ...
    // Integrated pages
    admin_issues: "Issues",
    admin_issues_tab_clusters: "Clusters",
    admin_issues_tab_events: "Events",
    admin_monitoring: "Monitoring",
    admin_monitoring_tab_kscore: "KScore Trending",
    admin_monitoring_tab_tension: "Tension Index",
    admin_avg_severity: "Avg Severity",
    admin_unclassified_rate: "Unclassified %",
    // Weekly report
    admin_wr_tab_preview: "Preview",
    admin_wr_tab_edit: "Edit",
    admin_wr_tab_history: "Send History",
    admin_wr_editor_note: "Editor Note",
    admin_wr_editor_note_ko: "Editor Note (Korean)",
    admin_wr_editor_note_en: "Editor Note (English)",
    admin_wr_editor_note_placeholder: "Write a note or comment for this week...",
    admin_wr_save_draft: "Save Draft",
    admin_wr_draft_saved: "Draft saved",
    admin_wr_send_test: "Test Send",
    admin_wr_send_all: "Send All",
    admin_wr_send_confirm: "Send to all recipients?",
    admin_wr_send_target: "Recipients",
    admin_wr_send_target_count: "{count} users",
    admin_wr_last_sent: "Last Sent",
    admin_wr_send_success: "Sent successfully",
    admin_wr_send_fail: "Send failed",
    admin_wr_history_date: "Date",
    admin_wr_history_sent: "Sent",
    admin_wr_history_failed: "Failed",
    admin_wr_history_status: "Status",
    admin_wr_no_history: "No send history",
    admin_wr_email_preview: "Email Preview",
    admin_wr_drag_reorder: "Drag to reorder",
    admin_wr_exclude: "Exclude",
    admin_wr_restore: "Restore",
    ...
    ob_hero_monitoring: "Monitoring 230+ countries",
    ob_hero_impact: "Analyze how global conflicts affect you",
    ...
    // Welcome Modal
    welcome_title: "How conflicts affect your wallet",
    welcome_subtitle: "Your daily conflict weather in 30 seconds",
    welcome_feat_1: "See how conflicts impact gas, groceries & flight prices",
    welcome_feat_2: "Real-time data from 13 agencies + satellite verification",
    welcome_feat_3: "Get alerted when conflicts may affect your daily costs",
    welcome_trust_1: "Multinational news + satellite & sensor data",
    welcome_trust_2: "Fact-based analysis, not predictions",
    welcome_trust_3: "Free to use",
    welcome_cta: "See today's conflict weather",
    ...
    banner_kscore_alert: "Risk Alert",
    banner_view: "View",
    banner_close: "Close",
    ...
    tour_home_country_picker: "Change the base country to re-rank issues by risk level from that country's perspective.",
    tour_home_rising: "Issues that have emerged within the last 6 hours and are spreading rapidly.",
    tour_home_kscore_history: "Tap 'View Risk Trend' at the bottom of a card to track changes over time.",
    ...
    tour_dash_top_issues: "Top 5 issues with the highest impact on you, personalized by risk level.",
    ...
    // Guide Tour — Settings
    tour_settings_page_role: "Manage notifications, base country, watched countries, and other settings.",
    tour_settings_home_country: "Base Country: risk level is calculated from this country's perspective. Alerts are also based on this risk level. Changeable on Pro and above.",
    ...
    tour_settings_notifications: "Adjust risk level threshold to control alert sensitivity. Lower values mean more alerts.",
    tour_settings_kscore_slider: "Risk level slider: You'll receive alerts when your base country risk level exceeds this value. Adjustable range varies by plan.",
    ...
    // Section descriptions (tooltips)
    dash_section_hero_title: "Impact",
    dash_section_hero_desc: "Impact on me",
    dash_section_hero_tooltip: "Overall impact score (0-100) measuring how conflicts affect your economy. The 5-axis radar breaks down risk across military, energy, trade, food & finance.",
    dash_section_radar_tooltip: "This week (red) vs last week (gray dashed) risk comparison across 5 domains. Larger area = higher risk.",
    dash_section_flow_tooltip: "Impact path: Conflicts (left) → Industries (center) → Your daily costs (right). Thicker flow = greater impact.",
    dash_section_stories_title: "Key Issues",
    dash_section_stories_desc: "Most relevant conflict issues for you",
    dash_section_stories_tooltip: "Higher impact score = more directly relevant to your country & economy. Each issue is summarized in 3 lines: What happened → Impact on me → Timeline.",
    dash_section_dashboard_title: "Data",
    dash_section_dashboard_desc: "Market, trade, travel & analysis details",
    dash_tab_market_desc: "Commodities, indices & FX affected by conflicts",
    dash_tab_trade_desc: "Trade dependency with conflict zones",
    dash_tab_travel_desc: "Travel advisory levels for conflict zones",
    dash_tab_detail_desc: "AI-powered comprehensive analysis",
    ...
    // UCDP conflict records (country page)
    ucdp_section_title: "Conflict Records",
    ucdp_period: "{start}-{end}: {count} recorded conflicts",
    ucdp_actors: "Key actors: {actors}",
    ucdp_fatalities: "Cumulative fatalities: ~{low}-{high}",
    ucdp_source: "UCDP GED · CC-BY 4.0",
    ...
    newsletter_subscribers: "{n} readers · Free · 3 min read",
    newsletter_login_subscribe: "Get it free",
    newsletter_login_sub: "Free after login",
    newsletter_subscribed: "Subscribed",
    newsletter_next_send: "Subscribed · Next issue Monday",
    newsletter_archive_title: "Newsletter Archive",
    newsletter_archive_desc: "Browse past newsletters",
