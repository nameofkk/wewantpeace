...
export const translations = {
  ko: {
    ...
    paywall_pro_feature_map: "시그널 교차검증 상세",
    ...
    settings_plan_pro_desc: "관심 국가 5개 · 일일 20건 · 신뢰 알림 · KScore 3.0~10.0 · 인텔리전스",
    ...
    settings_plan_proplus_desc: "무제한 국가 · 일일 100건 · 신뢰 알림 · KScore 1.5~10.0 · 90일 히스토리 · 인텔리전스",
    ...
    dash_section_stories_tooltip: "KScore가 높을수록 내 국가·경제에 직접 관련된 이슈입니다. 무슨 일(사건) → 나에게(영향) → 언제(시점) 3줄로 핵심을 요약합니다.",
  ...
  en: {
    ...
    paywall_pro_feature_map: "Signal cross-verification details",
    ...
    settings_plan_pro_desc: "5 countries · 20/day · Verified alerts · KScore 3.0–10.0 · Intelligence",
    ...
    settings_plan_proplus_desc: "Unlimited countries · 100/day · Verified alerts · KScore 1.5–10.0 · 90-day history · Intelligence",
    ...
    dash_section_stories_tooltip: "Higher KScore = more directly relevant to your country & economy. Each issue is summarized in 3 lines: What happened → Impact on me → Timeline.",
