...
export const translations = {
  ko: {
    ...
    dash_weekly_report_desc: "지난 7일간 주요 분쟁 이슈와 긴장도 변화를 요약합니다.",
    ...
    paywall_pro_feature_kscore: "KScore 3.0~ · 30일 히스토리",
    ...
    issue_kscore_history_expand: "KScore 히스토리 보기",
    issue_kscore_history_collapse: "KScore 히스토리 접기",
    issue_kscore_history_section: "KScore 추이",
    ...
    settings_home_country_desc: "KScore가 기준 국가 관점에서 계산됩니다",
    ...
    admin_active_subs: "유료 구독",
    admin_promo_subs: "프로모",
    ...
    welcome_trust_2: "심각도 분석 · 다출처 교차검증",
    ...
    tour_settings_home_country: "기준 국가: KScore가 이 국가 관점에서 계산됩니다. 알림도 이 KScore 기준으로 발송됩니다. Pro 이상에서 변경 가능.",
    ...
    tour_settings_kscore_slider: "KScore 슬라이더: 기준 국가 관점의 KScore가 이 값을 넘으면 알림이 발송됩니다. 플랜에 따라 조절 범위가 다릅니다.",
  ...
  en: {
    ...
    dash_weekly_report_desc: "A summary of major conflict issues and tension changes over the past 7 days.",
    ...
    paywall_pro_feature_kscore: "KScore 3.0+ · 30-day history",
    ...
    issue_kscore_history_expand: "View KScore History",
    issue_kscore_history_collapse: "Collapse KScore History",
    issue_kscore_history_section: "KScore Trend",
    ...
    settings_home_country_desc: "KScore is calculated from your base country's perspective",
    ...
    admin_active_subs: "Paid Subs",
    admin_promo_subs: "Promo",
    ...
    welcome_feat_2: "Tension analysis from global news data",
    ...
    tour_settings_home_country: "Base Country: KScore is calculated from this country's perspective. Alerts are also based on this KScore. Changeable on Pro and above.",
    ...
    tour_settings_kscore_slider: "KScore Slider: You'll receive alerts when your base country KScore exceeds this value. Adjustable range varies by plan.",
