...
export const translations = {
  ko: {
    ...
    dash_impact_brief_desc: "AI가 분석한 경제·무역·여행 영향도. 공개 데이터 기반 추정치입니다.",
  ...
  en: {
    ...
    dash_impact_brief_desc: "AI-analyzed economic, trade, and travel impact. Estimates based on public data.",
