...
export const translations = {
  ko: {
    ...
    settings_upgrade_for_unlimited: "Pro 10개 · Pro+ 무제한 — 업그레이드하면 더 추가 가능",
    ...
    settings_plan_pro_desc: "관심지역 10개 · 실시간 지도 · Fast 알림 가능",
  ...
  en: {
    ...
    settings_upgrade_for_unlimited: "Pro: 10 regions · Pro+: Unlimited — upgrade for more",
    ...
    settings_plan_pro_desc: "10 regions · Real-time map · Fast alerts enabled",
