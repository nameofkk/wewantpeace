...
export const translations = {
  ko: {
    ...
    glossary_kscore: "KScore (트렌딩 점수)",
    glossary_kscore_desc: "이슈의 종합 중요도를 0~10으로 나타낸 점수.\n속도(25%) + 심각도(40%) + 신뢰도(15%) + 확산도(20%)로 구성.",
  ...
  en: {
    ...
    glossary_kscore: "KScore (Trending Score)",
    glossary_kscore_desc: "A 0-10 score of issue importance.\nSpeed (25%) + Severity (40%) + Confidence (15%) + Spread (20%).",
