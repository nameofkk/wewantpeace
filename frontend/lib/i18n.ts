...
export const translations = {
  ko: {
    ...
    dash_section_stories_tooltip: "K스코어가 높을수록 내 국가·경제에 직접 관련된 이슈입니다. 무슨 일(사건) → 나에게(영향) → 언제(시점) 3줄로 핵심을 요약합니다.",
  ...
  en: {
    ...
    dash_risk_desc: "Shows your home country's conflict tension on a 0–100 scale. Updated every 15 minutes based on open news data.",
    ...
    tour_settings_home_country: "Base Country: KScore is calculated from this country's perspective. Alerts are also based on this KScore. Changeable on Pro+.",
