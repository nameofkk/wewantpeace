...
export const translations = {
  ko: {
    ...
    signal_rising_tooltip: "최근 6시간 내 생성되어 빠르게 부상 중인 이슈입니다.",
    ...
    // 온보딩 (5스텝 설정 마법사)
    ob_step_intent: "관심사를 알려주세요",
    ob_intent_travel: "여행",
    ob_intent_invest: "투자",
    ob_intent_expat: "해외근무",
    ob_intent_general: "일반관심",
    ob_step_countries: "관심 국가 선택",
    ob_countries_desc: "모니터링할 국가 2개를 선택하세요",
    ob_countries_pro_teaser: "Pro에서 5개까지 추적 가능",
    ob_step_alerts: "알림 설정",
    ob_alerts_desc: "중요한 이슈 발생 시 알려드립니다",
    ob_alerts_verified: "공식 확인 알림",
    ob_alerts_fast_locked: "Pro에서 속보 알림 받기",
    ob_alerts_allow: "알림 허용",
    ob_alerts_denied: "알림이 차단되었습니다",
    ob_alerts_granted: "알림이 허용되었습니다",
    ob_step_dnd: "방해금지 시간",
    ob_dnd_desc: "알림을 받지 않을 시간대를 설정하세요",
    ob_dnd_pro_only: "Pro 전용 기능",
    ob_dnd_preview: "22:00 — 07:00",
    ob_step_summary: "준비 완료!",
    ob_summary_desc: "맞춤 모니터링이 시작됩니다",
    ob_summary_fallback: "변동 감지 시 알려드릴게요",
    ob_summary_tension: "현재 긴장도 {score}점 ({grade})",
    ob_next: "다음",
    ob_skip: "건너뛰기",
    ob_start: "시작하기",
  ...
  en: {
    ...
    signal_rising_tooltip: "Rapidly rising issue from the last 6 hours.",
    ...
    ob_step_intent: "What's your interest?",
    ob_intent_travel: "Travel",
    ob_intent_invest: "Investment",
    ob_intent_expat: "Living abroad",
    ob_intent_general: "General interest",
    ob_step_countries: "Select countries",
    ob_countries_desc: "Choose 2 countries to monitor",
    ob_countries_pro_teaser: "Track up to 5 with Pro",
    ob_step_alerts: "Alert settings",
    ob_alerts_desc: "Get notified about important events",
    ob_alerts_verified: "Verified alerts",
    ob_alerts_fast_locked: "Get fast alerts with Pro",
    ob_alerts_allow: "Allow notifications",
    ob_alerts_denied: "Notifications blocked",
    ob_alerts_granted: "Notifications allowed",
    ob_step_dnd: "Quiet hours",
    ob_dnd_desc: "Set hours when you won't receive alerts",
    ob_dnd_pro_only: "Pro feature",
    ob_dnd_preview: "22:00 — 07:00",
    ob_step_summary: "All set!",
    ob_summary_desc: "Your personalized monitoring begins",
    ob_summary_fallback: "We'll notify you when changes are detected",
    ob_summary_tension: "Current tension: {score} ({grade})",
    ob_next: "Next",
    ob_skip: "Skip",
