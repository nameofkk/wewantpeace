...
export const translations = {
  ko: {
    ...
    paywall_pro_feature_countries: "관심 국가 5개 + 속보 알림",
    ...
    glossary_spike: "Spike (급등)",
    glossary_spike_desc: "단시간에 보도가 급증한 이슈. 이벤트가 빠르게 늘어나는 비정상적 상황을 감지합니다.",
    ...
    pipeline_spike_clusters: "스파이크 클러스터",
    ...
    pipeline_alert_spike: "스파이크 알림 전달 (최근 6시간)",
    pipeline_alert_spike_total: "전체 스파이크",
    pipeline_alert_spike_delivered: "알림 전달",
    pipeline_alert_spike_undelivered: "미전달",
    pipeline_alert_spike_warning: "미전달 스파이크가 있습니다!",
  ...
  en: {
    ...
    glossary_spike: "Spike",
    glossary_spike_desc: "An issue with a rapid surge in news coverage, indicating an abnormal increase in reporting.",
    ...
    pipeline_stage_spike: "Spike Detection",
    ...
    pipeline_spike_clusters: "Spike Clusters",
    ...
    pipeline_alert_spike: "Spike Alert Delivery (last 6h)",
    pipeline_alert_spike_total: "Total Spikes",
    pipeline_alert_spike_delivered: "Delivered",
    pipeline_alert_spike_undelivered: "Undelivered",
    pipeline_alert_spike_warning: "Undelivered spike alerts detected!",
    ...
    pipeline_no_spikes: "No active spikes",
