...
export const translations = {
  ko: {
    ...
    signal_kscore_tooltip: "트렌딩 종합 점수 (0~5).\n\n• 속도(35%): 이벤트 보도 건수\n• 심각도(35%): 위험 수준\n• 신뢰도(15%): 출처 품질\n• 확산도(15%): 독립 출처 수\n\n3.0↑ 매우 높음 / 2.0~3.0 높음 / 1.0~2.0 보통 / 1.0↓ 낮음",
    ...
    map_level_alert: "경계",
    map_level_crisis: "위기",
    map_kscore_legend: "KScore 기준: 위기 3.0↑ / 경계 2.0~3.0 / 주의 1.0~2.0 / 안정 1.0↓",
    map_popup_spike: "스파이크",
    map_popup_verified: "✓ 검증",
    map_popup_grouped: "총 {n}개 이슈",
    map_popup_rep_note: "KScore가 가장 높은 이슈가 대표로 표시됩니다",
    map_popup_kscore_tooltip: "트렌딩 점수 (0~5). 속도·심각도·신뢰도·확산도를 종합한 실시간 관심도 지수.",
    ...
    notif_kscore_free_hint: "Free 플랜 고정값 (1.0)",
    notif_kscore_low: "낮음",
  ...
  en: {
    ...
    signal_kscore_tooltip: "Trending composite score (0–5).\n\n• Speed (35%): event report count\n• Severity (35%): risk level\n• Credibility (15%): source quality\n• Spread (15%): independent sources\n\n3.0+ very high / 2.0–3.0 high / 1.0–2.0 medium / <1.0 low",
    ...
    map_kscore_legend: "KScore: Crisis 3.0+ / Alert 2.0–3.0 / Watch 1.0–2.0 / Normal <1.0",
    ...
    map_popup_kscore_tooltip: "Trending score (0–5). Combines speed, severity, credibility, and spread.",
    ...
    notif_kscore_free_hint: "Fixed at 1.0 on Free plan",
