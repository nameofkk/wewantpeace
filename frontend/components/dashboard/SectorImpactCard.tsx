    ...
    <div className="rounded-xl border border-border bg-card fade-in-up overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold">{t(lang, "dash_sector_impact")}</span>
          <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-purple-500/10 text-purple-400 font-medium">Pro+</span>
        </div>
          ...
          {data && (
            <div className="space-y-2 mt-3">
              ...
              {data.sectors.map((sector) => {
                ...
                return (
                  <div key={sector.sector} className="rounded-lg bg-muted/20 p-2.5">
