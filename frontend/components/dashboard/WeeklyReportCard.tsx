    ...
    <div className="rounded-xl border border-border bg-card fade-in-up overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-cyan-500/10 text-cyan-400 font-medium">Pro+</span>
        </div>
                  ...
                  <div className="space-y-1.5">
                    {data.top_issues.slice(0, 5).map((issue, idx) => (
                      <div
                        ...
                        className="flex items-center gap-2 rounded-lg bg-muted/10 px-2.5 py-2 cursor-pointer hover:bg-muted/20 transition-colors"
                      >
