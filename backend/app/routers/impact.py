...
SECTOR_DATA = {
    "KR": {
        "energy": {"gdp_pct": 3.2, "key_partners": ["SA", "AE", "IQ", "KW", "RU", "IR", "US", "QA", "NO"]},
        "semiconductor": {"gdp_pct": 4.8, "key_partners": ["US", "CN", "JP", "TW", "VN", "NL", "DE", "SG"]},
        "electronics": {"gdp_pct": 5.5, "key_partners": ["US", "CN", "VN", "JP", "IN", "TW", "DE"]},
        "manufacturing": {"gdp_pct": 25.0, "key_partners": ["CN", "US", "VN", "JP", "IN", "DE", "MX"]},
        "automotive": {"gdp_pct": 3.5, "key_partners": ["US", "CN", "IN", "DE", "AU", "MX", "GB"]},
        "agriculture": {"gdp_pct": 1.8, "key_partners": ["US", "AU", "BR", "UA", "RU", "CN", "AR"]},
        "shipping": {"gdp_pct": 2.1, "key_partners": ["CN", "JP", "US", "SG", "VN", "AE", "EG", "PA"]},
        "tourism": {"gdp_pct": 2.8, "key_partners": ["CN", "JP", "US", "TW", "TH", "VN", "SG"]},
        "defense": {"gdp_pct": 2.8, "key_partners": ["US", "DE", "IL", "AU", "FR", "JP", "KP", "CN", "RU", "IR"]},
        "technology": {"gdp_pct": 5.0, "key_partners": ["US", "CN", "JP", "TW", "IE", "IL", "IN", "DE"]},
    },
    "US": {
        "energy": {"gdp_pct": 5.8, "key_partners": ["CA", "SA", "MX", "RU", "IQ", "IR", "AE", "KW", "VE", "NO"]},
        "technology": {"gdp_pct": 8.2, "key_partners": ["CN", "TW", "KR", "JP", "IE", "IL", "IN", "DE"]},
        "semiconductor": {"gdp_pct": 2.5, "key_partners": ["TW", "KR", "JP", "CN", "NL", "IL", "DE", "SG"]},
        "manufacturing": {"gdp_pct": 11.0, "key_partners": ["CN", "MX", "CA", "DE", "JP", "KR", "VN", "IN"]},
        "shipping": {"gdp_pct": 2.8, "key_partners": ["CN", "JP", "KR", "DE", "GB", "SG", "EG", "PA"]},
        "automotive": {"gdp_pct": 3.0, "key_partners": ["MX", "CA", "JP", "DE", "KR", "CN", "GB"]},
        "agriculture": {"gdp_pct": 4.5, "key_partners": ["CN", "CA", "MX", "JP", "BR", "AU", "UA", "RU"]},
        "defense": {"gdp_pct": 3.4, "key_partners": ["GB", "AU", "JP", "KR", "IL", "SA", "IR", "CN", "RU", "DE"]},
        "tourism": {"gdp_pct": 2.6, "key_partners": ["MX", "CA", "GB", "JP", "CN", "DE", "FR", "BR"]},
    },
    "JP": {
        "energy": {"gdp_pct": 3.8, "key_partners": ["SA", "AE", "AU", "QA", "RU", "IR", "IQ", "KW", "US"]},
        "automotive": {"gdp_pct": 5.2, "key_partners": ["US", "CN", "TH", "ID", "DE", "KR", "IN", "MX"]},
        "electronics": {"gdp_pct": 4.1, "key_partners": ["CN", "US", "KR", "TW", "TH", "VN", "SG"]},
        "semiconductor": {"gdp_pct": 3.0, "key_partners": ["US", "TW", "CN", "KR", "NL", "DE", "SG"]},
        "manufacturing": {"gdp_pct": 20.0, "key_partners": ["US", "CN", "KR", "TH", "DE", "VN", "IN"]},
        "agriculture": {"gdp_pct": 1.1, "key_partners": ["US", "AU", "CA", "BR", "TH", "CN", "UA", "RU"]},
        "shipping": {"gdp_pct": 1.8, "key_partners": ["CN", "US", "KR", "AU", "TW", "SG", "AE", "EG"]},
        "tourism": {"gdp_pct": 1.5, "key_partners": ["CN", "KR", "TW", "US", "TH", "SG", "AU"]},
        "defense": {"gdp_pct": 1.0, "key_partners": ["US", "CN", "KR", "KP", "RU", "AU", "IR"]},
    },
    "CN": {
        "energy": {"gdp_pct": 6.5, "key_partners": ["SA", "RU", "IQ", "AE", "IR", "KW", "US", "AU", "BR"]},
        "technology": {"gdp_pct": 7.5, "key_partners": ["US", "KR", "TW", "JP", "DE", "IL", "NL", "SG"]},
        "manufacturing": {"gdp_pct": 27.0, "key_partners": ["US", "JP", "KR", "DE", "VN", "IN", "MX", "TW"]},
        "agriculture": {"gdp_pct": 7.3, "key_partners": ["BR", "US", "AU", "AR", "CA", "UA", "RU", "TH"]},
        "shipping": {"gdp_pct": 3.5, "key_partners": ["US", "JP", "KR", "SG", "DE", "AE", "EG", "AU"]},
        "tourism": {"gdp_pct": 2.2, "key_partners": ["TH", "JP", "KR", "US", "SG", "AU", "VN"]},
        "defense": {"gdp_pct": 1.7, "key_partners": ["US", "RU", "TW", "JP", "KR", "IN", "KP", "IR"]},
    },
    "DE": {
        "energy": {"gdp_pct": 3.5, "key_partners": ["NO", "US", "NL", "RU", "GB", "SA", "IR", "IQ", "AE"]},
        "automotive": {"gdp_pct": 5.0, "key_partners": ["US", "CN", "GB", "FR", "IT", "JP", "KR", "MX"]},
        "manufacturing": {"gdp_pct": 19.7, "key_partners": ["US", "CN", "FR", "NL", "PL", "GB", "IT", "CZ"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["NL", "CN", "US", "FR", "PL", "EG", "SG", "AE"]},
        "electronics": {"gdp_pct": 3.2, "key_partners": ["CN", "US", "NL", "FR", "CZ", "TW", "KR", "JP"]},
        "agriculture": {"gdp_pct": 0.8, "key_partners": ["NL", "FR", "PL", "IT", "ES", "UA", "RU", "BR"]},
        "tourism": {"gdp_pct": 2.5, "key_partners": ["NL", "CH", "AT", "US", "GB", "FR", "IT"]},
        "defense": {"gdp_pct": 1.3, "key_partners": ["US", "FR", "GB", "RU", "IL", "IR", "CN", "PL"]},
    },
    "GB": {
        "energy": {"gdp_pct": 3.2, "key_partners": ["NO", "US", "NL", "QA", "SA", "IR", "RU", "IQ", "AE"]},
        "finance": {"gdp_pct": 8.3, "key_partners": ["US", "DE", "FR", "NL", "JP", "CN", "SG", "HK"]},
        "technology": {"gdp_pct": 5.5, "key_partners": ["US", "DE", "IE", "NL", "CN", "IL", "JP", "IN"]},
        "manufacturing": {"gdp_pct": 9.0, "key_partners": ["US", "DE", "FR", "NL", "CN", "JP", "IT"]},
        "shipping": {"gdp_pct": 1.5, "key_partners": ["NL", "US", "DE", "FR", "CN", "EG", "SG", "AE"]},
        "agriculture": {"gdp_pct": 0.6, "key_partners": ["IE", "NL", "FR", "DE", "ES", "UA", "BR"]},
        "tourism": {"gdp_pct": 3.0, "key_partners": ["US", "FR", "DE", "IE", "ES", "IT", "AU"]},
        "defense": {"gdp_pct": 2.2, "key_partners": ["US", "FR", "DE", "AU", "SA", "IR", "RU", "IL", "CN"]},
    },
    "FR": {
        "energy": {"gdp_pct": 2.8, "key_partners": ["NO", "SA", "US", "RU", "NE", "IR", "IQ", "AE", "DZ"]},
        "automotive": {"gdp_pct": 2.5, "key_partners": ["DE", "ES", "IT", "GB", "BE", "CN", "US"]},
        "manufacturing": {"gdp_pct": 10.0, "key_partners": ["DE", "US", "IT", "ES", "BE", "CN", "GB"]},
        "shipping": {"gdp_pct": 1.8, "key_partners": ["DE", "US", "CN", "NL", "IT", "EG", "SG"]},
        "agriculture": {"gdp_pct": 1.7, "key_partners": ["DE", "BE", "IT", "ES", "NL", "UA", "RU", "BR"]},
        "tourism": {"gdp_pct": 4.2, "key_partners": ["GB", "DE", "BE", "NL", "US", "CN", "IT"]},
        "defense": {"gdp_pct": 1.9, "key_partners": ["US", "GB", "DE", "IN", "SA", "IR", "RU", "IL"]},
    },
    "AU": {
        "energy": {"gdp_pct": 8.5, "key_partners": ["CN", "JP", "KR", "IN", "TW", "SA", "IR", "SG"]},
        "mining": {"gdp_pct": 10.5, "key_partners": ["CN", "JP", "KR", "IN", "US", "TW", "DE"]},
        "agriculture": {"gdp_pct": 2.3, "key_partners": ["CN", "JP", "US", "KR", "ID", "VN", "IN"]},
        "tourism": {"gdp_pct": 2.8, "key_partners": ["NZ", "CN", "US", "GB", "JP", "SG", "KR"]},
        "technology": {"gdp_pct": 3.5, "key_partners": ["US", "NZ", "SG", "GB", "JP", "IL", "CN"]},
        "defense": {"gdp_pct": 2.0, "key_partners": ["US", "GB", "JP", "CN", "KR", "NZ", "IR", "RU"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["CN", "JP", "KR", "SG", "US", "NZ", "EG", "AE"]},
    },
    "IN": {
        "energy": {"gdp_pct": 4.5, "key_partners": ["SA", "IQ", "AE", "RU", "KW", "IR", "US", "QA", "NG"]},
        "technology": {"gdp_pct": 8.0, "key_partners": ["US", "GB", "SG", "DE", "JP", "IL", "CN", "AU"]},
        "agriculture": {"gdp_pct": 17.0, "key_partners": ["US", "AE", "CN", "BD", "NL", "UA", "RU", "BR"]},
        "manufacturing": {"gdp_pct": 14.0, "key_partners": ["US", "AE", "CN", "HK", "SG", "DE", "JP"]},
        "tourism": {"gdp_pct": 2.5, "key_partners": ["BD", "US", "GB", "SG", "AE", "TH", "JP"]},
        "defense": {"gdp_pct": 2.4, "key_partners": ["US", "RU", "FR", "IL", "CN", "PK", "IR", "GB"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["AE", "SA", "CN", "SG", "US", "EG", "YE"]},
    },
    "BR": {
        "energy": {"gdp_pct": 4.0, "key_partners": ["US", "CN", "AR", "NL", "CL", "SA", "IR"]},
        "agriculture": {"gdp_pct": 7.5, "key_partners": ["CN", "US", "NL", "JP", "DE", "UA", "RU"]},
        "mining": {"gdp_pct": 4.5, "key_partners": ["CN", "US", "JP", "AR", "NL", "DE"]},
        "manufacturing": {"gdp_pct": 11.0, "key_partners": ["US", "AR", "CN", "MX", "DE", "JP"]},
        "tourism": {"gdp_pct": 2.0, "key_partners": ["AR", "US", "CL", "PY", "UY"]},
        "defense": {"gdp_pct": 1.3, "key_partners": ["US", "FR", "IL", "GB", "RU", "CN"]},
    },
    "SA": {
        "energy": {"gdp_pct": 40.0, "key_partners": ["CN", "IN", "JP", "KR", "US", "IR", "IQ", "AE"]},
        "construction": {"gdp_pct": 5.5, "key_partners": ["CN", "US", "GB", "DE", "FR", "IN"]},
        "tourism": {"gdp_pct": 3.5, "key_partners": ["EG", "PK", "IN", "ID", "BD", "IR"]},
        "manufacturing": {"gdp_pct": 12.0, "key_partners": ["CN", "US", "DE", "JP", "IT", "KR"]},
        "defense": {"gdp_pct": 6.0, "key_partners": ["US", "GB", "FR", "IR", "YE", "IL", "CN"]},
        "shipping": {"gdp_pct": 3.0, "key_partners": ["CN", "IN", "JP", "KR", "EG", "AE", "YE"]},
    },
    "AE": {
        "energy": {"gdp_pct": 30.0, "key_partners": ["JP", "IN", "CN", "KR", "TH", "IR", "SA", "IQ"]},
        "finance": {"gdp_pct": 9.0, "key_partners": ["US", "GB", "IN", "SA", "CN", "SG"]},
        "tourism": {"gdp_pct": 5.5, "key_partners": ["IN", "GB", "SA", "RU", "CN", "DE", "US"]},
        "shipping": {"gdp_pct": 4.0, "key_partners": ["CN", "IN", "US", "SA", "JP", "EG", "YE", "IR"]},
        "defense": {"gdp_pct": 5.0, "key_partners": ["US", "FR", "GB", "IR", "YE", "SA", "IL"]},
    },
    "IL": {
        "technology": {"gdp_pct": 12.0, "key_partners": ["US", "CN", "GB", "DE", "IN", "JP", "KR"]},
        "defense": {"gdp_pct": 5.2, "key_partners": ["US", "DE", "IN", "IT", "GB", "IR", "LB", "PS", "SY", "YE"]},
        "agriculture": {"gdp_pct": 1.1, "key_partners": ["NL", "GB", "FR", "DE", "US"]},
        "tourism": {"gdp_pct": 2.8, "key_partners": ["US", "FR", "DE", "GB", "RU"]},
        "energy": {"gdp_pct": 2.5, "key_partners": ["US", "AE", "SA", "IR", "EG"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["US", "CN", "DE", "EG", "YE", "IR"]},
    },
    "TR": {
        "manufacturing": {"gdp_pct": 20.0, "key_partners": ["DE", "US", "GB", "IT", "IQ", "CN", "FR"]},
        "agriculture": {"gdp_pct": 6.5, "key_partners": ["IQ", "DE", "RU", "US", "GB", "UA", "IR"]},
        "energy": {"gdp_pct": 3.0, "key_partners": ["RU", "IR", "IQ", "AZ", "SA", "US"]},
        "tourism": {"gdp_pct": 4.5, "key_partners": ["DE", "RU", "GB", "BG", "GE", "IR", "UA"]},
        "automotive": {"gdp_pct": 3.5, "key_partners": ["DE", "GB", "FR", "IT", "US", "CN"]},
        "defense": {"gdp_pct": 1.8, "key_partners": ["US", "RU", "IR", "IL", "SY", "IQ", "GR"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["DE", "US", "CN", "RU", "EG", "IQ"]},
    },
    "TW": {
        "semiconductor": {"gdp_pct": 15.0, "key_partners": ["US", "CN", "JP", "KR", "SG", "NL", "DE"]},
        "electronics": {"gdp_pct": 8.0, "key_partners": ["CN", "US", "JP", "KR", "HK", "VN", "SG"]},
        "manufacturing": {"gdp_pct": 30.0, "key_partners": ["CN", "US", "JP", "HK", "KR", "VN"]},
        "agriculture": {"gdp_pct": 1.5, "key_partners": ["US", "BR", "AU", "NZ", "JP"]},
        "tourism": {"gdp_pct": 1.8, "key_partners": ["JP", "KR", "CN", "US", "HK"]},
        "defense": {"gdp_pct": 2.3, "key_partners": ["US", "CN", "JP", "KR", "IL"]},
        "energy": {"gdp_pct": 3.0, "key_partners": ["SA", "AE", "KW", "QA", "AU", "IR", "IQ"]},
        "shipping": {"gdp_pct": 2.5, "key_partners": ["CN", "US", "JP", "KR", "SG", "EG"]},
    },
    "TH": {
        "tourism": {"gdp_pct": 11.5, "key_partners": ["CN", "MY", "KR", "IN", "JP", "RU", "US"]},
        "automotive": {"gdp_pct": 5.5, "key_partners": ["US", "AU", "JP", "CN", "MY", "ID"]},
        "agriculture": {"gdp_pct": 8.5, "key_partners": ["CN", "US", "JP", "VN", "MY", "UA"]},
        "electronics": {"gdp_pct": 6.0, "key_partners": ["US", "CN", "JP", "HK", "SG"]},
        "energy": {"gdp_pct": 3.5, "key_partners": ["SA", "AE", "QA", "MY", "KW", "IR", "IQ"]},
        "shipping": {"gdp_pct": 2.5, "key_partners": ["CN", "JP", "US", "SG", "MY", "EG"]},
        "defense": {"gdp_pct": 1.4, "key_partners": ["US", "CN", "KR", "IL", "MM"]},
    },
    "VN": {
        "manufacturing": {"gdp_pct": 25.0, "key_partners": ["US", "CN", "KR", "JP", "NL", "DE"]},
        "electronics": {"gdp_pct": 8.0, "key_partners": ["US", "CN", "KR", "JP", "HK", "TW"]},
        "agriculture": {"gdp_pct": 12.0, "key_partners": ["US", "CN", "JP", "KR", "PH", "UA"]},
        "tourism": {"gdp_pct": 3.0, "key_partners": ["KR", "CN", "JP", "TW", "US", "TH"]},
        "energy": {"gdp_pct": 3.0, "key_partners": ["CN", "JP", "KR", "MY", "SG", "SA", "IR"]},
        "shipping": {"gdp_pct": 3.0, "key_partners": ["CN", "KR", "JP", "US", "SG", "EG"]},
    },
    "SG": {
        "finance": {"gdp_pct": 13.5, "key_partners": ["US", "CN", "GB", "HK", "JP", "IN", "DE"]},
        "shipping": {"gdp_pct": 7.0, "key_partners": ["CN", "MY", "US", "ID", "JP", "KR", "AE", "EG", "YE", "IR"]},
        "technology": {"gdp_pct": 9.0, "key_partners": ["US", "CN", "MY", "JP", "KR", "IL", "TW"]},
        "tourism": {"gdp_pct": 4.0, "key_partners": ["ID", "CN", "IN", "MY", "AU", "JP"]},
        "manufacturing": {"gdp_pct": 20.0, "key_partners": ["CN", "MY", "US", "HK", "JP", "KR", "TW"]},
        "energy": {"gdp_pct": 3.0, "key_partners": ["SA", "AE", "IR", "IQ", "MY", "AU"]},
        "defense": {"gdp_pct": 3.0, "key_partners": ["US", "FR", "DE", "CN", "MY", "ID"]},
    },
    "CA": {
        "energy": {"gdp_pct": 10.0, "key_partners": ["US", "CN", "GB", "JP", "KR", "SA", "IR"]},
        "mining": {"gdp_pct": 5.0, "key_partners": ["US", "CN", "GB", "JP", "DE", "KR"]},
        "agriculture": {"gdp_pct": 1.8, "key_partners": ["US", "CN", "JP", "MX", "GB", "UA", "RU"]},
        "automotive": {"gdp_pct": 2.5, "key_partners": ["US", "MX", "JP", "DE", "KR", "CN"]},
        "technology": {"gdp_pct": 5.0, "key_partners": ["US", "GB", "DE", "FR", "CN", "IL"]},
        "tourism": {"gdp_pct": 2.0, "key_partners": ["US", "GB", "FR", "MX", "DE"]},
        "defense": {"gdp_pct": 1.3, "key_partners": ["US", "GB", "FR", "RU", "CN", "IR"]},
        "shipping": {"gdp_pct": 1.5, "key_partners": ["US", "CN", "JP", "DE", "EG"]},
    },
    "MX": {
        "manufacturing": {"gdp_pct": 18.0, "key_partners": ["US", "CN", "CA", "DE", "JP", "KR"]},
        "energy": {"gdp_pct": 5.5, "key_partners": ["US", "ES", "NL", "CN", "IN", "SA", "IR"]},
        "automotive": {"gdp_pct": 4.0, "key_partners": ["US", "CA", "DE", "JP", "BR", "KR", "CN"]},
        "agriculture": {"gdp_pct": 3.5, "key_partners": ["US", "JP", "CA", "CN", "GT"]},
        "tourism": {"gdp_pct": 3.5, "key_partners": ["US", "CA", "GB", "CO", "AR"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["US", "CN", "CA", "DE", "JP", "EG"]},
    },
    "RU": {
        "energy": {"gdp_pct": 25.0, "key_partners": ["CN", "IN", "TR", "DE", "NL", "JP", "KR", "SA", "IR"]},
        "mining": {"gdp_pct": 8.0, "key_partners": ["CN", "NL", "DE", "TR", "KR", "JP", "IN"]},
        "agriculture": {"gdp_pct": 4.0, "key_partners": ["TR", "CN", "EG", "KZ", "BY", "UA", "IN"]},
        "defense": {"gdp_pct": 3.9, "key_partners": ["IN", "CN", "EG", "DZ", "VN", "IR", "US", "UA"]},
        "manufacturing": {"gdp_pct": 13.0, "key_partners": ["CN", "BY", "KZ", "TR", "DE", "IN"]},
        "shipping": {"gdp_pct": 2.0, "key_partners": ["CN", "TR", "IN", "EG", "KR"]},
    },
    "ID": {  # 인도네시아
        "energy": {"gdp_pct": 3.5, "key_partners": ["SA", "AE", "MY", "NG", "IQ", "IR", "KW"]},
        "manufacturing": {"gdp_pct": 20.0, "key_partners": ["CN", "JP", "US", "KR", "TH", "SG"]},
        "agriculture": {"gdp_pct": 13.0, "key_partners": ["CN", "US", "IN", "JP", "MY", "UA"]},
        "mining": {"gdp_pct": 7.0, "key_partners": ["CN", "JP", "IN", "KR", "US"]},
        "tourism": {"gdp_pct": 4.5, "key_partners": ["MY", "SG", "AU", "CN", "JP", "KR"]},
        "shipping": {"gdp_pct": 3.0, "key_partners": ["CN", "JP", "SG", "US", "KR", "EG"]},
        "defense": {"gdp_pct": 0.8, "key_partners": ["US", "KR", "FR", "CN", "RU"]},
    },
    "PH": {  # 필리핀
        "electronics": {"gdp_pct": 6.0, "key_partners": ["US", "CN", "JP", "HK", "SG", "TW", "KR"]},
        "manufacturing": {"gdp_pct": 18.0, "key_partners": ["US", "JP", "CN", "HK", "SG", "KR"]},
        "agriculture": {"gdp_pct": 9.0, "key_partners": ["US", "JP", "CN", "HK", "NL"]},
        "shipping": {"gdp_pct": 3.0, "key_partners": ["US", "CN", "JP", "SG", "HK", "EG"]},
        "tourism": {"gdp_pct": 5.5, "key_partners": ["KR", "US", "JP", "CN", "AU"]},
        "energy": {"gdp_pct": 2.5, "key_partners": ["SA", "AE", "KW", "IR", "IQ", "MY"]},
        "defense": {"gdp_pct": 1.0, "key_partners": ["US", "JP", "KR", "CN", "AU"]},
    },
    "PL": {  # 폴란드
        "manufacturing": {"gdp_pct": 18.0, "key_partners": ["DE", "FR", "GB", "CZ", "IT", "CN", "US"]},
        "automotive": {"gdp_pct": 4.0, "key_partners": ["DE", "GB", "FR", "IT", "CZ", "US"]},
        "agriculture": {"gdp_pct": 2.5, "key_partners": ["DE", "GB", "FR", "NL", "IT", "UA", "RU"]},
        "energy": {"gdp_pct": 4.0, "key_partners": ["DE", "NO", "US", "SA", "RU", "IR"]},
        "technology": {"gdp_pct": 5.0, "key_partners": ["DE", "US", "GB", "FR", "NL"]},
        "defense": {"gdp_pct": 4.0, "key_partners": ["US", "KR", "DE", "GB", "RU", "UA", "FR"]},
        "shipping": {"gdp_pct": 1.5, "key_partners": ["DE", "CN", "US", "NL", "EG"]},
    },
    "EG": {  # 이집트
        "energy": {"gdp_pct": 6.0, "key_partners": ["IT", "US", "IN", "ES", "TR", "SA", "IR", "IQ"]},
        "tourism": {"gdp_pct": 5.0, "key_partners": ["DE", "GB", "RU", "SA", "US", "IL"]},
        "agriculture": {"gdp_pct": 11.0, "key_partners": ["SA", "US", "IT", "TR", "LY", "UA", "RU"]},
        "shipping": {"gdp_pct": 3.5, "key_partners": ["SA", "US", "CN", "IN", "AE", "YE", "IR"]},
        "manufacturing": {"gdp_pct": 15.0, "key_partners": ["US", "SA", "TR", "IT", "DE"]},
        "defense": {"gdp_pct": 1.2, "key_partners": ["US", "FR", "RU", "IL", "SA", "LY", "SD"]},
    },
}
